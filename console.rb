...
film1 = Film.new( {'title' => 'Terminator', 'price' => 10, 'show_time' => 19.40, 'seats_unoccupied' => 10} )
film1.save()
film2 = Film.new( {'title' => 'Titanic', 'price' => 2.0, 'show_time' => 18.00, 'seats_unoccupied' => 6} )
film2.save()
film3 = Film.new( {'title' => 'Seven', 'price' => 12.50, 'show_time' => 22.30, 'seats_unoccupied' => 12} )
film3.save()
film4 = Film.new( {'title' => 'Bad Boys 2', 'price' => 6.40, 'show_time' => 16.00, 'seats_unoccupied' => 4} )
film4.save()
film5 = Film.new( {'title' => 'Terminator', 'price' => 5.50,'show_time' => 17.10, 'seats_unoccupied' => 2} )
film5.save()
